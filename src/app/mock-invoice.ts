...
let invoice01 = new Invoice('In001', {
  invoiceDate: new Date('2018-02-04'), invoiceNumber: '2018abcd', recipient: 'DumpfbackeGmbH',
...
let invoice02 = new Invoice('In002', {
  invoiceDate: new Date('2018-04-01'), invoiceNumber: '2018efgh', recipient: 'Goldbroiler',
