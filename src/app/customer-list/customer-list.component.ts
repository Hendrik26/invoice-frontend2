...
export class CustomerListComponent implements OnInit {
    customer1 = {customerId: 'cus01', customerName: 'Schweizer Käse&Socken GmbH', country: 'Schweiz',postalCode: 'CH-0815',
        city: 'Bern', addressLine1: 'Almweg 88', addressLine2: '', addressLine3: '', customerSalesTaxNumber: '7-40-11'};
    customer2 = {customerId: 'cus02', customerName: 'DumpfbackeGmbH', country: 'DDR', postalCode: 'D-6969',
